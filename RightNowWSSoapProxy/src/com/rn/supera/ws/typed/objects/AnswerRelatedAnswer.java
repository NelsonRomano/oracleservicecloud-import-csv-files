        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                               ...
                               */
                               public void setLearnedStrength(int param){
                                       ...
                                       // setting primitive attribute tracker to true
                                           ...
                                           localLearnedStrengthTracker = false;
                                              
                                       } else {
                                          localLearnedStrengthTracker = true;
                                       }
                               ...
                               */
                               public void setSimilarityStrength(int param){
                                       ...
                                       // setting primitive attribute tracker to true
                                               ...
                                               if (param==java.lang.Integer.MIN_VALUE) {
                                           localSimilarityStrengthTracker = false;
                                              
                                       } else {
                                          localSimilarityStrengthTracker = true;
                                       }
                        ...
                        */
                                    ...
                                    protected com.rn.supera.ws.typed.base.NamedID localToAnswer ;
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           */
                           public  com.rn.supera.ws.typed.base.NamedID getToAnswer(){
                            ...
                            /**
                               ...
                               */
                               public void setToAnswer(com.rn.supera.ws.typed.base.NamedID param){
                            
                                       if (param != null){
                                          //update the setting tracker
                                          localToAnswerTracker = true;
                                       } else {
                                          localToAnswerTracker = false;
                        ...
                        */
                                    ...
                                    protected com.rn.supera.ws.typed.nullfields.AnswerRelatedAnswerNullFields localValidNullFields ;
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           */
                           ...
                           /**
                           * Auto generated getter method
                           * @return com.rn.supera.ws.typed.nullfields.AnswerRelatedAnswerNullFields
                           */
                           public  com.rn.supera.ws.typed.nullfields.AnswerRelatedAnswerNullFields getValidNullFields(){
                            ...
                            /**
                               ...
                               */
                               public void setValidNullFields(com.rn.supera.ws.typed.nullfields.AnswerRelatedAnswerNullFields param){
       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       AnswerRelatedAnswer.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
                           ...
                           xmlWriter);
                                    ...
                                    if (! namespace.equals("")) {
                                        ...
                                        if (prefix == null) {
                                            ...
                                            xmlWriter.writeStartElement(prefix,"LearnedStrength", namespace);
                                            xmlWriter.writeNamespace(prefix, namespace);
                                            xmlWriter.setPrefix(prefix, namespace);

                                        } else {
                                            xmlWriter.writeStartElement(namespace,"LearnedStrength");
                                        }

                                    } else {
                                        xmlWriter.writeStartElement("LearnedStrength");
                                    }
                                   ...
                                   xmlWriter.writeEndElement();
                                    ...
                                    if (! namespace.equals("")) {
                                        ...
                                        if (prefix == null) {
                                            ...
                                            xmlWriter.writeStartElement(prefix,"ManualStrength", namespace);
                                            xmlWriter.writeNamespace(prefix, namespace);
                                            xmlWriter.setPrefix(prefix, namespace);

                                        } else {
                                            xmlWriter.writeStartElement(namespace,"ManualStrength");
                                        }

                                    } else {
                                        xmlWriter.writeStartElement("ManualStrength");
                                    }
                                   ...
                                   xmlWriter.writeEndElement();
                                    ...
                                    if (! namespace.equals("")) {
                                        ...
                                        if (prefix == null) {
                                            ...
                                            xmlWriter.writeStartElement(prefix,"SimilarityStrength", namespace);
                                            xmlWriter.writeNamespace(prefix, namespace);
                                            xmlWriter.setPrefix(prefix, namespace);

                                        } else {
                                            xmlWriter.writeStartElement(namespace,"SimilarityStrength");
                                        }

                                    } else {
                                        xmlWriter.writeStartElement("SimilarityStrength");
                                    }
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"AnswerRelatedAnswer".equals(type)){
                                ...
                                return (AnswerRelatedAnswer)com.rn.supera.ws.typed.base.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                   ...
                   if (tempAttribAction!=null){
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("urn:objects.ws.rightnow.com/v1_3","ToAnswer").equals(reader.getName())){
                                                ...
                                                object.setToAnswer(com.rn.supera.ws.typed.base.NamedID.Factory.parse(reader));
                                      ...
                                      if ("true".equals(nillableValue) || "1".equals(nillableValue)){
                                          ...
                                          reader.next();
                                            ...
                                            reader.next();
                                                ...
                                                object.setValidNullFields(com.rn.supera.ws.typed.nullfields.AnswerRelatedAnswerNullFields.Factory.parse(reader));
