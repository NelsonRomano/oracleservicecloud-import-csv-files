                               ...
                               */
                               public void setInvalid(boolean param){
                                       ...
                                       // setting primitive attribute tracker to true
                                               ...
                                               if (false) {
                                           localInvalidTracker = false;
                                              
                                       } else {
                                          localInvalidTracker = true;
                                       }
                                   ...
                                   xmlWriter.writeEndElement();
                                    ...
                                    if (! namespace.equals("")) {
                                        ...
                                        if (prefix == null) {
                                            ...
                                            xmlWriter.writeStartElement(prefix,"Invalid", namespace);
                                            xmlWriter.writeNamespace(prefix, namespace);
                                            xmlWriter.setPrefix(prefix, namespace);

                                        } else {
                                            xmlWriter.writeStartElement(namespace,"Invalid");
                                        }

                                    } else {
                                        xmlWriter.writeStartElement("Invalid");
                                    }
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"Email".equals(type)){
                                ...
                                return (Email)com.rn.supera.ws.typed.base.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
