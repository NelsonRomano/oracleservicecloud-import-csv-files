        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        */
                                    ...
                                    protected com.rn.supera.ws.typed.base.NamedID localPhoneType ;
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           */
                           public  com.rn.supera.ws.typed.base.NamedID getPhoneType(){
                            ...
                            /**
                               ...
                               */
                               public void setPhoneType(com.rn.supera.ws.typed.base.NamedID param){
                            
                                       if (param != null){
                                          //update the setting tracker
                                          localPhoneTypeTracker = true;
                                       } else {
                                          localPhoneTypeTracker = false;
                            ...
                            /**
                               ...
                               */
                               public void setRawNumber(java.lang.String param){
                                       ...
                                       if (param != null){
                                          //update the setting tracker
                                          localRawNumberTracker = true;
                                       } else {
                                          localRawNumberTracker = false;
       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       Phone.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
                                   ...
                                   xmlWriter.writeEndElement();
                                    ...
                                    if (! namespace.equals("")) {
                                        ...
                                        if (prefix == null) {
                                            ...
                                            xmlWriter.writeStartElement(prefix,"RawNumber", namespace);
                                            xmlWriter.writeNamespace(prefix, namespace);
                                            xmlWriter.setPrefix(prefix, namespace);

                                        } else {
                                            xmlWriter.writeStartElement(namespace,"RawNumber");
                                        }

                                    } else {
                                        xmlWriter.writeStartElement("RawNumber");
                                    }
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"Phone".equals(type)){
                                ...
                                return (Phone)com.rn.supera.ws.typed.base.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                   ...
                   if (tempAttribAction!=null){
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("urn:objects.ws.rightnow.com/v1_3","PhoneType").equals(reader.getName())){
                                                ...
                                                object.setPhoneType(com.rn.supera.ws.typed.base.NamedID.Factory.parse(reader));
