                               ...
                               */
                               public void setEditable(boolean param){
                                       ...
                                       // setting primitive attribute tracker to true
                                               ...
                                               if (false) {
                                           localEditableTracker = false;
                                              
                                       } else {
                                          localEditableTracker = true;
                                       }
       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       AnalyticsReportFilterAttributes.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"AnalyticsReportFilterAttributes".equals(type)){
                                ...
                                return (AnalyticsReportFilterAttributes)com.rn.supera.ws.typed.base.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
