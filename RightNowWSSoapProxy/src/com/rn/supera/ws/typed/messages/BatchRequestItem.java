        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        */
                                    ...
                                    protected com.rn.supera.ws.typed.messages.BatchRequestItemChoice_type0 localBatchRequestItemChoice_type0 ;
                                

                           /**
                           * Auto generated getter method
                           * @return com.rn.supera.ws.typed.messages.BatchRequestItemChoice_type0
                           */
                           public  com.rn.supera.ws.typed.messages.BatchRequestItemChoice_type0 getBatchRequestItemChoice_type0(){
                            ...
                            /**
                               ...
                               */
                               public void setBatchRequestItemChoice_type0(com.rn.supera.ws.typed.messages.BatchRequestItemChoice_type0 param){
                               ...
                               */
                               public void setCommitAfter(boolean param){
                                       ...
                                       // setting primitive attribute tracker to true
                                               ...
                                               if (false) {
                                           localCommitAfterTracker = false;
                                              
                                       } else {
                                          localCommitAfterTracker = true;
                                       }
                               ...
                               */
                               public void setPreserveChainID(boolean param){
                                       ...
                                       // setting primitive attribute tracker to true
                                               ...
                                               if (false) {
                                           localPreserveChainIDTracker = false;
                                              
                                       } else {
                                          localPreserveChainIDTracker = true;
                                       }
       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       BatchRequestItem.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       ...
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           ...
                           xmlWriter);
                                           ...
                                           localBatchRequestItemChoice_type0.serialize(null,factory,xmlWriter);
                                    ...
                                    if (! namespace.equals("")) {
                                        ...
                                        if (prefix == null) {
                                            ...
                                            xmlWriter.writeStartElement(prefix,"CommitAfter", namespace);
                                            xmlWriter.writeNamespace(prefix, namespace);
                                            xmlWriter.setPrefix(prefix, namespace);

                                        } else {
                                            xmlWriter.writeStartElement(namespace,"CommitAfter");
                                        }

                                    } else {
                                        xmlWriter.writeStartElement("CommitAfter");
                                    }
                                   ...
                                   xmlWriter.writeEndElement();
                                    ...
                                    if (! namespace.equals("")) {
                                        ...
                                        if (prefix == null) {
                                            ...
                                            xmlWriter.writeStartElement(prefix,"PreserveChainID", namespace);
                                            xmlWriter.writeNamespace(prefix, namespace);
                                            xmlWriter.setPrefix(prefix, namespace);

                                        } else {
                                            xmlWriter.writeStartElement(namespace,"PreserveChainID");
                                        }

                                    } else {
                                        xmlWriter.writeStartElement("PreserveChainID");
                                    }
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"BatchRequestItem".equals(type)){
                                ...
                                return (BatchRequestItem)com.rn.supera.ws.typed.base.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() ){
                                                ...
                                                object.setBatchRequestItemChoice_type0(com.rn.supera.ws.typed.messages.BatchRequestItemChoice_type0.Factory.parse(reader));
